                ...
                <div class="row record-row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="d-flex align-items-center h-100 w-100">
                            ...
                            <button class="btn btn-lg btn-outline-success record-upload mr-2"><i class="mdi mdi-upload"></i> Upload</button>
                            <button class="btn btn-lg btn-outline-warning record-mic"><i class="mdi mdi-microphone"> Record</i></button>
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="not-selected indicators border-bottom h-100 @if($item->exists) d-none @endif">
                            <div class="d-flex align-items-center h-100">
                                <span class="d-inline-flex">Nothing Selected !</span>
                            </div>
                        </div>
                        ...
                        <div class="player indicators @if(!$item->exists) d-none @endif">
                            <div class="waveform" data-value="{{storage_asset($value(old($name)))}}"></div>
