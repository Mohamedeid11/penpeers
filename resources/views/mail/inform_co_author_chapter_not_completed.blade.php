                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                            Please be inform that Mr.<a style="color: #ce7852; text-decoration: underline;"
                                    href="{!! $author_link !!}">{{ $lead_author_name }}</a> changed the status of
                                chapter (<a style="color: #ce7852; text-decoration: underline;"
                                    href="{!! $chapter_link !!}">{{ $chapter_name }}</a>) on book (<a
                                    style="color: #ce7852; text-decoration: underline;"
                                    href="{!! $book_link !!}"><strong>{{ $book_title }}</strong></a>) from completed to
                                be re-edited . <br>
                                Please find his notes: <br>
                                "<i style="color: var(--main-color);">{{ $remarks }}</i>"
