                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            font-family: 'Open Sans', sans-serif;">
                                @if($remaining > 0)
                                    Your free trial ends in {{$remaining}} {{$remaining_text}}, Please login to subscribe from
                                    <a href="{{route('web.dashboard.account.status')}}" style="color: #63caf7; text-decoration: none">here</a> .
                                @else
                                    your free trial has ended, Please login to subscribe from
                                    <a href="{{route('web.dashboard.account.status')}}" style="color: #63caf7; text-decoration: none">here</a> or you can delete your account from <a href="{{route('web.dashboard.account.status') . '#delete-section'}}" style="color: #63caf7; text-decoration: none">here</a> .
                                @endif
                            </p>
                        </td>
                    </tr>
