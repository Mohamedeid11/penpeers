                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                                New book join request to book <a style="color: #ce7852; text-decoration: underline;"
                                    href="{{ route('web.view_book', ['slug' => $slug]) }}"><strong>{{ $book_name }}</strong></a>
                                from
                                Mr.{!! $sender !!},
                                you can check join requests from <a style="color: #ce7852; text-decoration: underline;"
                                    href=" {{ $button }}"> here </a> .<br>
                            </p>
                        </td>
                    </tr>
