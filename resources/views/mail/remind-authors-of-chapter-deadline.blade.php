                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            ...
                            line-height: 30px;
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">Dear <strong>{{$author_name}}<strong>,</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                                The deadline of chapter <strong>{{$chapter_name}}</strong> of <strong>{{$book_name}}</strong> book ends tomorrow.
                            </p>
                        </td>
                    </tr>
