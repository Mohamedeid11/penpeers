                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            ...
                            line-height: 30px;
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">Dear <strong>{{$co_author_name}}<strong>,</p>
                        </td>
                    </tr>
                        ...
                        <td style="padding-bottom: 40px">
                            ...
                            font-family: 'Open Sans', sans-serif;">
                                <a style='color: #ce7852; text-decoration: underline'
                                    href="{!! $author_link !!}"><strong>{{ $lead_author }}</strong></a> has accepted
                                your request to participate in this book <a
                                    style='color: #ce7852; text-decoration: underline' href="{!! $book_link !!}">
                                    <strong>{{ $book_title }}</strong></a> .
                                {!! $register_text !!} .
                            </p>
                        </td>
                    </tr>
