                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                                Your request to participate in <a style="color: #ce7852; text-decoration: underline;"
                                    href="{{ route('web.view_book', ['slug' => $slug]) }}"><strong>{{ $book_name }}</strong></a>
                                book, has sent successfully.<br>
                                Mr. <a style="color: #ce7852; text-decoration: underline;"
                                    href="{{ route('web.author_books', ['author' => $lead_author_id, 'type' => 'all_books']) }}"><strong>{{ $lead_author }}</strong></a>
