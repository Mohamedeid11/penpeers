                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            ...
                            line-height: 30px;
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">Dear <strong>{{$book_author_name}}<strong>,</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                                This is a reminder for a pending request to join <a
                                    style="color: #ce7852; text-decoration: underline;"
                                    href="{!! $book_link !!}"><strong>{{ $book_name }}</strong></a> book from <a
                                    style="color: #ce7852; text-decoration: underline;"
                                    href="{!! $author_link !!}"><strong>{{ $name }}</strong></a>. <br>
                                You can check other requests from <a style="color: #ce7852; text-decoration: underline;"
                                    href="{{ route('web.dashboard.books.requests',['book' => $book_id]) }}">here</a>.
                            </p>
                        </td>
                    </tr>
