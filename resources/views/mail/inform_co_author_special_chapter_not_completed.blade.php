                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            font-size: 28px;
                            text-align: center;">
                           Welcome To <a href="{{route('web.get_landing')}}">   PenPeers.com </a>
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            font-family: 'Open Sans', sans-serif;">
                                Your Lead-author
                                <a href= "{!! $author_link !!}" > {{$lead_author_name}} </a>
                                 Tell You Are Not  Finish The Special Chapter
                                <a href= "{!! $chapter_link !!}" > {{$chapter_name}} </a>
                                 Of Book
