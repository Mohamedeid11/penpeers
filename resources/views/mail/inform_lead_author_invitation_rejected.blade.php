                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            ...
                            line-height: 30px;
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">Dear <a
                                style="color: #ce7852; text-decoration: underline;" href="{!! $author_link !!}">
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            ...
                            text-align: center;
                            font-family: 'Open Sans', sans-serif;">
                                <a style="color: #ce7852; text-decoration: underline;"  href="{!! $participant_link !!}">{{ $participant_name }}</a> with email
                                {{ $participant_email }} has rejected participating in your book

                                <a style='color: #ce7852; text-decoration: underline' href="{!! $book_link !!}">
                                    <strong>{{ $book_title }}</strong></a> . <br>
                            </p>
                        </td>
                    </tr>
