...
$configArray["gatewayUrl"] =  $_ENV['GATEWAY_BASE_URL'];

// Merchant ID supplied by your payments provider
$configArray["merchantId"] =  $_ENV['GATEWAY_MERCHANT_ID'];

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "merchant" . $_ENV['GATEWAY_MERCHANT_ID'];

// API password which can be configured in Merchant Administration
$configArray["password"] = $_ENV['GATEWAY_API_PASSWORD'];
